            ...
            <div className="space-y-5 text-slate-600">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="font-medium block hover:text-brand-blue cursor-pointer text-[15px] text-slate-700 transition-colors">www.hubeixx.com</span>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="w-full bg-slate-100 rounded-xl min-h-[400px] relative overflow-hidden group">
              <div className="absolute inset-0 bg-[#e5e3df] flex items-center justify-center">
                <div className="text-slate-400 flex flex-col items-center">
                  ...
                  <p className="text-sm font-medium opacity-50 tracking-widest">MAP DISPLAY / 地图展示区</p>
                </div>
              </div>
              <img 
                src="https://raw.githubusercontent.com/yilin20020116-lab/companyweb-images/refs/heads/main/%E5%9C%B0%E5%9B%BE.png" 
                alt="兴欣科技地图位置" 
              ...
              <div className="absolute bottom-6 left-6 right-6 z-30">
                <div className="bg-white/95 backdrop-blur-sm p-5 rounded-xl shadow-lg flex flex-col md:flex-row items-start md:items-center justify-between border-l-4 border-brand-blue gap-4">
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mt-1">地址：湖北省鄂州市四海大道58号</p>
                  </div>
                  <div className="flex flex-col items-end gap-1">
                    <div className="flex items-center gap-2 bg-[#559bd9]/10 text-brand-blue px-4 py-2 rounded-lg text-sm font-bold whitespace-nowrap">
                      <Clock size={18} /> 
                      <span>夏令时 8:00 - 17:30 / 冬令时 8:00 - 17:00</span>
                    </div>
                  </div>
                </div>
              </div>
